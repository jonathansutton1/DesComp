...
SIGNAL \flipFlop|DOUT~0_combout\ : std_logic;
SIGNAL \DECODER|saida[4]~8_combout\ : std_logic;
...
SIGNAL \flipFlop|DOUT~1_combout\ : std_logic;
SIGNAL \flipFlop|DOUT~2_combout\ : std_logic;
SIGNAL \flipFlop|DOUT~3_combout\ : std_logic;
SIGNAL \flipFlop|DOUT~4_combout\ : std_logic;
SIGNAL \flipFlop|DOUT~q\ : std_logic;
...
SIGNAL \DECODER|ALT_INV_saida[4]~8_combout\ : std_logic;
SIGNAL \flipFlop|ALT_INV_DOUT~3_combout\ : std_logic;
...
SIGNAL \flipFlop|ALT_INV_DOUT~2_combout\ : std_logic;
...
SIGNAL \flipFlop|ALT_INV_DOUT~1_combout\ : std_logic;
...
SIGNAL \flipFlop|ALT_INV_DOUT~0_combout\ : std_logic;
...
SIGNAL \flipFlop|ALT_INV_DOUT~q\ : std_logic;
...
\DECODER|ALT_INV_saida[4]~8_combout\ <= NOT \DECODER|saida[4]~8_combout\;
\REGA|ALT_INV_DOUT\(7) <= NOT \REGA|DOUT\(7);
\flipFlop|ALT_INV_DOUT~3_combout\ <= NOT \flipFlop|DOUT~3_combout\;
...
\flipFlop|ALT_INV_DOUT~2_combout\ <= NOT \flipFlop|DOUT~2_combout\;
...
\flipFlop|ALT_INV_DOUT~1_combout\ <= NOT \flipFlop|DOUT~1_combout\;
...
\flipFlop|ALT_INV_DOUT~0_combout\ <= NOT \flipFlop|DOUT~0_combout\;
...
\flipFlop|ALT_INV_DOUT~q\ <= NOT \flipFlop|DOUT~q\;
...
-- Equation(s):
-- \DECODER|Equal10~0_combout\ = ( \ROM1|memROM~4_combout\ & ( \ROM1|memROM~1_combout\ ) ) # ( !\ROM1|memROM~4_combout\ & ( (\ROM1|memROM~1_combout\ & (((\ROM1|memROM~3_combout\) # (\ROM1|memROM~2_combout\)) # (\ROM1|memROM~0_combout\))) ) )
...
-- Equation(s):
-- \DECODER|saida~1_combout\ = ( \ROM1|memROM~4_combout\ ) # ( !\ROM1|memROM~4_combout\ & ( ((!\ROM1|memROM~1_combout\) # ((!\ROM1|memROM~2_combout\) # (\ROM1|memROM~3_combout\))) # (\ROM1|memROM~0_combout\) ) )
...
\flipFlop|DOUT~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \flipFlop|DOUT~0_combout\ = (\DECODER|saida~1_combout\ & \flipFlop|DOUT~q\)
...
PORT MAP (
	...
	datab => \flipFlop|ALT_INV_DOUT~q\,
	combout => \flipFlop|DOUT~0_combout\);

\DECODER|saida[4]~8\ : cyclonev_lcell_comb
-- Equation(s):
-- \DECODER|saida[4]~8_combout\ = ( \ROM1|memROM~4_combout\ & ( !\ROM1|memROM~1_combout\ ) ) # ( !\ROM1|memROM~4_combout\ & ( (!\ROM1|memROM~1_combout\) # ((!\ROM1|memROM~0_combout\ & !\ROM1|memROM~2_combout\)) ) )
...
PORT MAP (
	...
	datac => \ROM1|ALT_INV_memROM~2_combout\,
	datae => \ROM1|ALT_INV_memROM~4_combout\,
	combout => \DECODER|saida[4]~8_combout\);

\DECODER|saida[6]~4\ : cyclonev_lcell_comb
-- Equation(s):
-- \DECODER|saida[6]~4_combout\ = ( \ROM1|memROM~4_combout\ & ( (!\ROM1|memROM~0_combout\ & (\ROM1|memROM~1_combout\ & (!\ROM1|memROM~2_combout\ & !\ROM1|memROM~3_combout\))) ) )
...
-- Equation(s):
-- \DECODER|saida[5]~3_combout\ = ( \ROM1|memROM~4_combout\ & ( (!\ROM1|memROM~0_combout\ & (\ROM1|memROM~1_combout\ & (!\ROM1|memROM~2_combout\ & !\ROM1|memROM~3_combout\))) ) ) # ( !\ROM1|memROM~4_combout\ & ( (\ROM1|memROM~1_combout\ & 
...
-- Equation(s):
-- \MUX2|saida_MUX[6]~7_combout\ = (\MUX2|saida_MUX[4]~4_combout\ & ((!\DECODER|saida~7_combout\ & ((\incrementaPC|Add0~25_sumout\))) # (\DECODER|saida~7_combout\ & (\ENDRET|DOUT\(6)))))
...
-- Equation(s):
-- \MUX2|saida_MUX[7]~8_combout\ = (\MUX2|saida_MUX[4]~4_combout\ & ((!\DECODER|saida~7_combout\ & ((\incrementaPC|Add0~29_sumout\))) # (\DECODER|saida~7_combout\ & (\ENDRET|DOUT\(7)))))
...
-- Equation(s):
-- \MUX2|saida_MUX[8]~9_combout\ = ( \ENDRET|DOUT\(8) & ( \incrementaPC|Add0~33_sumout\ & ( ((\ROM1|memROM~1_combout\ & (!\PC|DOUT[1]~0_combout\ & \ROM1|memROM~9_combout\))) # (\PC|DOUT[1]~1_combout\) ) ) ) # ( !\ENDRET|DOUT\(8) & ( 
-- \incrementaPC|Add0~33_sumout\ & ( (!\PC|DOUT[1]~0_combout\ & (((\ROM1|memROM~1_combout\ & \ROM1|memROM~9_combout\)) # (\PC|DOUT[1]~1_combout\))) ) ) ) # ( \ENDRET|DOUT\(8) & ( !\incrementaPC|Add0~33_sumout\ & ( (!\PC|DOUT[1]~0_combout\ & 
-- (\ROM1|memROM~1_combout\ & (!\PC|DOUT[1]~1_combout\ & \ROM1|memROM~9_combout\))) # (\PC|DOUT[1]~0_combout\ & (((\PC|DOUT[1]~1_combout\)))) ) ) ) # ( !\ENDRET|DOUT\(8) & ( !\incrementaPC|Add0~33_sumout\ & ( (\ROM1|memROM~1_combout\ & 
...
-- Equation(s):
-- \ROM1|memROM~6_combout\ = ( !\PC|DOUT\(8) & ( \ROM1|memROM~11_combout\ & ( (!\PC|DOUT\(4) & (!\PC|DOUT\(5) & (!\PC|DOUT\(6) & !\PC|DOUT\(7)))) ) ) )
...
-- Equation(s):
-- \DECODER|saida[4]~2_combout\ = ( \ROM1|memROM~4_combout\ & ( (!\ROM1|memROM~0_combout\ & (\ROM1|memROM~1_combout\ & (!\ROM1|memROM~2_combout\ & !\ROM1|memROM~3_combout\))) ) ) # ( !\ROM1|memROM~4_combout\ & ( (!\ROM1|memROM~0_combout\ & 
...
-- Equation(s):
-- \ULA1|saida[0]~4_combout\ = (!\DECODER|saida[4]~2_combout\ & ((\ULA1|Add0~17_sumout\))) # (\DECODER|saida[4]~2_combout\ & (\MUX1|saida_MUX[0]~0_combout\))
...
-- pragma translate_on
PORT MAP (
	dataa => \DECODER|ALT_INV_saida[4]~2_combout\,
...
-- Equation(s):
-- \MUX1|saida_MUX[0]~0_combout\ = (!\DECODER|saida[6]~4_combout\ & ((\RAM|ram~160_combout\))) # (\DECODER|saida[6]~4_combout\ & (\ROM1|memROM~5_combout\))
...
-- Equation(s):
-- \ULA1|saida[1]~5_combout\ = (!\DECODER|saida[4]~2_combout\ & ((\ULA1|Add0~21_sumout\))) # (\DECODER|saida[4]~2_combout\ & (\MUX1|saida_MUX[1]~1_combout\))
...
-- Equation(s):
-- \MUX1|saida_MUX[1]~1_combout\ = (!\DECODER|saida[6]~4_combout\ & ((\RAM|ram~165_combout\))) # (\DECODER|saida[6]~4_combout\ & (\ROM1|memROM~6_combout\))
...
-- Equation(s):
-- \ULA1|saida[2]~6_combout\ = (!\DECODER|saida[4]~2_combout\ & ((\ULA1|Add0~25_sumout\))) # (\DECODER|saida[4]~2_combout\ & (\MUX1|saida_MUX[2]~2_combout\))
...
-- Equation(s):
-- \MUX1|saida_MUX[2]~2_combout\ = (!\DECODER|saida[6]~4_combout\ & ((\RAM|ram~167_combout\))) # (\DECODER|saida[6]~4_combout\ & (\ROM1|memROM~7_combout\))
...
-- Equation(s):
-- \ULA1|saida[3]~7_combout\ = (!\DECODER|saida[4]~2_combout\ & ((\ULA1|Add0~29_sumout\))) # (\DECODER|saida[4]~2_combout\ & (\MUX1|saida_MUX[3]~3_combout\))
...
-- Equation(s):
-- \MUX1|saida_MUX[3]~3_combout\ = (!\DECODER|saida[6]~4_combout\ & ((\RAM|ram~172_combout\))) # (\DECODER|saida[6]~4_combout\ & (\ROM1|memROM~8_combout\))
...
-- Equation(s):
-- \ULA1|Add0~13_sumout\ = SUM(( (!\RAM|ram~158_combout\) # ((!\DECODER|saida[4]~8_combout\ & \DECODER|saida[6]~4_combout\)) ) + ( \REGA|DOUT\(4) ) + ( \ULA1|Add0~30\ ))
-- \ULA1|Add0~14\ = CARRY(( (!\RAM|ram~158_combout\) # ((!\DECODER|saida[4]~8_combout\ & \DECODER|saida[6]~4_combout\)) ) + ( \REGA|DOUT\(4) ) + ( \ULA1|Add0~30\ ))
...
-- pragma translate_on
PORT MAP (
	datab => \DECODER|ALT_INV_saida[4]~8_combout\,
	datac => \RAM|ALT_INV_ram~158_combout\,
	datad => \DECODER|ALT_INV_saida[6]~4_combout\,
...
-- Equation(s):
-- \ULA1|saida[4]~3_combout\ = (!\DECODER|saida[4]~2_combout\ & \ULA1|Add0~13_sumout\)
...
-- pragma translate_on
PORT MAP (
	datac => \DECODER|ALT_INV_saida[4]~2_combout\,
...
-- Equation(s):
-- \ULA1|Add0~9_sumout\ = SUM(( (!\RAM|ram~156_combout\) # ((!\DECODER|saida[4]~8_combout\ & \DECODER|saida[6]~4_combout\)) ) + ( \REGA|DOUT\(5) ) + ( \ULA1|Add0~14\ ))
-- \ULA1|Add0~10\ = CARRY(( (!\RAM|ram~156_combout\) # ((!\DECODER|saida[4]~8_combout\ & \DECODER|saida[6]~4_combout\)) ) + ( \REGA|DOUT\(5) ) + ( \ULA1|Add0~14\ ))
...
PORT MAP (
	datab => \DECODER|ALT_INV_saida[4]~8_combout\,
	datac => \DECODER|ALT_INV_saida[6]~4_combout\,
...
-- Equation(s):
-- \ULA1|saida[5]~2_combout\ = (!\DECODER|saida[4]~2_combout\ & \ULA1|Add0~9_sumout\)
...
-- Equation(s):
-- \ULA1|Add0~5_sumout\ = SUM(( (!\RAM|ram~151_combout\) # ((!\DECODER|saida[4]~8_combout\ & \DECODER|saida[6]~4_combout\)) ) + ( \REGA|DOUT\(6) ) + ( \ULA1|Add0~10\ ))
-- \ULA1|Add0~6\ = CARRY(( (!\RAM|ram~151_combout\) # ((!\DECODER|saida[4]~8_combout\ & \DECODER|saida[6]~4_combout\)) ) + ( \REGA|DOUT\(6) ) + ( \ULA1|Add0~10\ ))
...
-- Equation(s):
-- \ULA1|saida[6]~1_combout\ = (!\DECODER|saida[4]~2_combout\ & \ULA1|Add0~5_sumout\)
...
-- Equation(s):
-- \ULA1|Add0~1_sumout\ = SUM(( (!\RAM|ram~149_combout\) # ((!\DECODER|saida[4]~8_combout\ & \DECODER|saida[6]~4_combout\)) ) + ( \REGA|DOUT\(7) ) + ( \ULA1|Add0~6\ ))
...
-- Equation(s):
-- \ULA1|saida[7]~0_combout\ = (\ULA1|Add0~1_sumout\ & !\DECODER|saida[4]~2_combout\)
...
PORT MAP (
	...
	datad => \DECODER|ALT_INV_saida[4]~2_combout\,
	combout => \ULA1|saida[7]~0_combout\);

\flipFlop|DOUT~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \flipFlop|DOUT~1_combout\ = ( \ULA1|Add0~9_sumout\ & ( \ULA1|Add0~13_sumout\ & ( !\DECODER|saida[4]~2_combout\ ) ) ) # ( !\ULA1|Add0~9_sumout\ & ( \ULA1|Add0~13_sumout\ & ( !\DECODER|saida[4]~2_combout\ ) ) ) # ( \ULA1|Add0~9_sumout\ & ( 
-- !\ULA1|Add0~13_sumout\ & ( !\DECODER|saida[4]~2_combout\ ) ) )
...
PORT MAP (
	...
	combout => \flipFlop|DOUT~1_combout\);

\flipFlop|DOUT~2\ : cyclonev_lcell_comb
-- Equation(s):
-- \flipFlop|DOUT~2_combout\ = ( !\MUX1|saida_MUX[1]~1_combout\ & ( \ULA1|Add0~21_sumout\ & ( (!\DECODER|saida~1_combout\ & (\DECODER|saida[4]~2_combout\ & !\MUX1|saida_MUX[0]~0_combout\)) ) ) ) # ( \MUX1|saida_MUX[1]~1_combout\ & ( !\ULA1|Add0~21_sumout\ & 
-- ( (!\DECODER|saida~1_combout\ & (!\DECODER|saida[4]~2_combout\ & !\ULA1|Add0~17_sumout\)) ) ) ) # ( !\MUX1|saida_MUX[1]~1_combout\ & ( !\ULA1|Add0~21_sumout\ & ( (!\DECODER|saida~1_combout\ & ((!\DECODER|saida[4]~2_combout\ & ((!\ULA1|Add0~17_sumout\))) # 
-- (\DECODER|saida[4]~2_combout\ & (!\MUX1|saida_MUX[0]~0_combout\)))) ) ) )
...
PORT MAP (
	...
	combout => \flipFlop|DOUT~2_combout\);

\flipFlop|DOUT~3\ : cyclonev_lcell_comb
-- Equation(s):
-- \flipFlop|DOUT~3_combout\ = ( \ULA1|Add0~29_sumout\ & ( (\DECODER|saida[4]~2_combout\ & (!\MUX1|saida_MUX[2]~2_combout\ & !\MUX1|saida_MUX[3]~3_combout\)) ) ) # ( !\ULA1|Add0~29_sumout\ & ( (!\DECODER|saida[4]~2_combout\ & (((!\ULA1|Add0~25_sumout\)))) # 
-- (\DECODER|saida[4]~2_combout\ & (!\MUX1|saida_MUX[2]~2_combout\ & ((!\MUX1|saida_MUX[3]~3_combout\)))) ) )
...
PORT MAP (
	...
	combout => \flipFlop|DOUT~3_combout\);

\flipFlop|DOUT~4\ : cyclonev_lcell_comb
-- Equation(s):
-- \flipFlop|DOUT~4_combout\ = ( \flipFlop|DOUT~2_combout\ & ( \flipFlop|DOUT~3_combout\ & ( ((!\ULA1|saida[7]~0_combout\ & (!\ULA1|saida[6]~1_combout\ & !\flipFlop|DOUT~1_combout\))) # (\flipFlop|DOUT~0_combout\) ) ) ) # ( !\flipFlop|DOUT~2_combout\ & ( 
-- \flipFlop|DOUT~3_combout\ & ( \flipFlop|DOUT~0_combout\ ) ) ) # ( \flipFlop|DOUT~2_combout\ & ( !\flipFlop|DOUT~3_combout\ & ( \flipFlop|DOUT~0_combout\ ) ) ) # ( !\flipFlop|DOUT~2_combout\ & ( !\flipFlop|DOUT~3_combout\ & ( \flipFlop|DOUT~0_combout\ ) ) 
-- )
...
-- pragma translate_on
PORT MAP (
	dataa => \flipFlop|ALT_INV_DOUT~0_combout\,
	datab => \ULA1|ALT_INV_saida[7]~0_combout\,
	datac => \ULA1|ALT_INV_saida[6]~1_combout\,
	datad => \flipFlop|ALT_INV_DOUT~1_combout\,
	datae => \flipFlop|ALT_INV_DOUT~2_combout\,
	dataf => \flipFlop|ALT_INV_DOUT~3_combout\,
	combout => \flipFlop|DOUT~4_combout\);

\flipFlop|DOUT\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
-- Equation(s):
-- \DECODER|saida~5_combout\ = ( \ROM1|memROM~4_combout\ & ( (\ROM1|memROM~0_combout\ & (\ROM1|memROM~1_combout\ & (!\ROM1|memROM~2_combout\ & \ROM1|memROM~3_combout\))) ) )
...
-- Equation(s):
-- \PC|DOUT[1]~1_combout\ = ( \DECODER|saida~5_combout\ & ( (!\flipFlop|DOUT~q\ & ((!\DECODER|Equal10~0_combout\) # ((!\DECODER|saida~6_combout\ & !\DECODER|Equal4~0_combout\)))) ) ) # ( !\DECODER|saida~5_combout\ & ( (!\DECODER|Equal10~0_combout\) # 
-- ((!\DECODER|saida~6_combout\ & !\DECODER|Equal4~0_combout\)) ) )
...
-- Equation(s):
-- \DECODER|saida~6_combout\ = ( !\ROM1|memROM~4_combout\ & ( (!\ROM1|memROM~0_combout\ & (\ROM1|memROM~1_combout\ & (\ROM1|memROM~2_combout\ & \ROM1|memROM~3_combout\))) ) )
...
-- Equation(s):
-- \MUX2|saida_MUX[4]~4_combout\ = (!\DECODER|saida~6_combout\ & (!\DECODER|Equal4~0_combout\ & ((!\flipFlop|DOUT~q\) # (!\DECODER|saida~5_combout\))))
...
PORT MAP (
	...
	datac => \flipFlop|ALT_INV_DOUT~q\,
	datad => \DECODER|ALT_INV_saida~5_combout\,
...
-- Equation(s):
-- \MUX2|saida_MUX[5]~6_combout\ = (\MUX2|saida_MUX[4]~4_combout\ & ((!\DECODER|saida~7_combout\ & ((\incrementaPC|Add0~21_sumout\))) # (\DECODER|saida~7_combout\ & (\ENDRET|DOUT\(5)))))
...
-- Equation(s):
-- \DECODER|Equal4~0_combout\ = ( \ROM1|memROM~4_combout\ & ( (\ROM1|memROM~0_combout\ & (\ROM1|memROM~1_combout\ & (!\ROM1|memROM~2_combout\ & !\ROM1|memROM~3_combout\))) ) )
...
-- Equation(s):
-- \PC|DOUT[1]~0_combout\ = (\DECODER|saida~7_combout\ & !\DECODER|Equal4~0_combout\)
...
-- Equation(s):
-- \DECODER|saida~7_combout\ = ( !\ROM1|memROM~4_combout\ & ( (\ROM1|memROM~0_combout\ & (\ROM1|memROM~1_combout\ & (\ROM1|memROM~2_combout\ & !\ROM1|memROM~3_combout\))) ) )
...
-- Equation(s):
-- \MUX2|saida_MUX[4]~5_combout\ = (\MUX2|saida_MUX[4]~4_combout\ & ((!\DECODER|saida~7_combout\ & ((\incrementaPC|Add0~17_sumout\))) # (\DECODER|saida~7_combout\ & (\ENDRET|DOUT\(4)))))
...
-- Equation(s):
-- \DECODER|Equal5~0_combout\ = ( \ROM1|memROM~4_combout\ & ( (!\ROM1|memROM~0_combout\ & (\ROM1|memROM~1_combout\ & (!\ROM1|memROM~2_combout\ & \ROM1|memROM~3_combout\))) ) )
...
-- Equation(s):
-- \DECODER|saida[1]~0_combout\ = ( !\ROM1|memROM~4_combout\ & ( (\ROM1|memROM~1_combout\ & (!\ROM1|memROM~2_combout\ $ (((!\ROM1|memROM~0_combout\ & !\ROM1|memROM~3_combout\))))) ) )
